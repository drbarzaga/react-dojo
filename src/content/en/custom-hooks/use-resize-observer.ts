...
export const useResizeObserver: CustomHook = {
  ...
  description:
    "Observes size changes on a specific element using ResizeObserver. Returns a ref, the current width, and the current height of the element.",
  category: "dom",
  ...
  return (
    <div style={{ padding: 20, fontFamily: "sans-serif" }}>
      ...
      >
        ...
        <div style={{ fontSize: 12, color: "var(--fg-muted)" }}>width × height (px)</div>
      </div>
    </div>
  )
}`,
