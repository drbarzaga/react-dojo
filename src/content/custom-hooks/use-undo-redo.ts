...
export const useUndoRedo: CustomHook = {
  ...
  label: "useUndoRedo",
  description:
    "Gestiona historial de estados con soporte para deshacer y rehacer operaciones usando useReducer.",
  category: "state",
...
export function useUndoRedo<T>(initialState: T, maxHistory = 100): UseUndoRedoReturn<T> {
  ...
  playground: {
    files: {
      "/App.js": `import { useReducer, useCallback, useState } from "react"
  ...
  return (
    <div style={{ padding: "24px", fontFamily: "sans-serif", maxWidth: 400 }}>
      ...
      <p style={{ color: "var(--fg-muted)", fontSize: 13, marginBottom: 20 }}>
        Selecciona un color. Usa Deshacer y Rehacer para navegar el historial.
      </p>
